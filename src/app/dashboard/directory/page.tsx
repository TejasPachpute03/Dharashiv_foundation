...
function DirectoryContent() {
  ...
  const clearFilters = () => {
    setSearchQuery("");
    setSelectedCategory("");
    setSelectedLocation("Dharashiv");
    setSelectedTaluka("");
    setSelectedLookingFor("");
    setSortBy("recommended");
  };

  const hasActiveFilters = searchQuery || selectedCategory || (selectedLocation && selectedLocation !== "Dharashiv") || selectedLookingFor || selectedTaluka;
